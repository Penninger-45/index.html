...
<head>
    ...
    <title>Ms. Penninger's Class Hub</title>
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 20px;
            /* --- CHANGED: Added the TikTok/Instagram style gradient --- */
        ...
        /* Styling for the daily agenda entries */
        .agenda-day {
            /* --- CHANGED: Updated border color to match the new theme --- */
            border-left: 4px solid #833AB4;
            padding-left: 15px;
            margin-bottom: 25px;
        }
        /* Styling for the generator tools */
        button {
            /* --- CHANGED: Updated button color to match the new theme --- */
        ...
        button:hover {
            background-color: #6a2da2; /* A slightly darker purple for hover */
        }
        textarea {
            width: 100%;
            margin-top: 10px;
